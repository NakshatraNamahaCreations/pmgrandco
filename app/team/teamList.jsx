...
export default function TeamList() {
  ...
  <FaEnvelope />
          ...
          <div className="editorial-content">
            ...
            <p>
              Pramoth works with organisations across geographies to enhance
              financial systems, improve governance, and modernise accounting
              operations. With experience spanning valuation, cross-border
              bookkeeping, and financial system automation, he helps clients
            ...
            <ul>
              ...
              <li>Process audits & internal control strengthening</li>
              <li>Financial workflow engineering</li>
              <li>Audits for societies & non-profits</li>
            </ul>
          </div>
        </article>
  ...
  <FaEnvelope />
          ...
          <div className="editorial-content">
            ...
            <p>
              ...
              frameworks, and financial planning assignments, strengthened by
              her Big Four background. She works with individuals, start-ups,
              and corporates to evaluate systems, assess risks, and design
